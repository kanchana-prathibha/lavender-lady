    ...
    <div class="card mb-3" id="cardview">
        <div class="row g-0">
            ...
            <div class="col-md-12 col-lg-4 col-sm-1">
                <div class="card-body">
                    <h4 class="card-title" id="title">AMANI SLEEVLESS FRILL HEM MINI DRESS</h4>
                    <h7 class="card-text" id="discription">Frill hem detailed sleeveless casual dress with round neckline.</h7>
                    <p class="card-text" id="price">Rs.2600.00</p>
                </div>
...
<div class="container">
    <div class="card mb-3" id="cardview">
        <div class="row g-0">
            ...
            <div class="col-md-4" id="image">
                <img src="https://fbpros3v1.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2023/11/0300916179BK-1ladies-blouse_fashion-bug_srilanka_compressed-300x382.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            ...
            <div class="col-md-12 col-lg-4 col-sm-1">
                <div class="card-body">
                    <h4 class="card-title" id="title">AMANI SLEEVLESS FRILL HEM MINI DRESS</h4>
                    <h7 class="card-text" id="discription">Frill hem detailed sleeveless casual dress with round neckline.</h7>
                    <p class="card-text" id="price">Rs.2500.00</p>
                </div>
...
<div class="container">
    <div class="card mb-3" id="cardview">
        <div class="row g-0">
            ...
            <div class="col-md-4" id="image">
                <img src="https://fbpros3v1.s3.ap-southeast-1.amazonaws.com/wp-content/uploads/2023/11/0300916179WHT-M-3ladies-blouse_fashion-bug-srilanak_compressed-300x382.jpg" class="img-fluid rounded-start" alt="...">
            </div>
            ...
            <div class="col-md-12 col-lg-4 col-sm-1">
                <div class="card-body">
                    <h4 class="card-title" id="title">AMANI SLEEVLESS FRILL HEM MINI DRESS</h4>
                    <h7 class="card-text" id="discription">Frill hem detailed sleeveless casual dress with round neckline.</h7>
                    <p class="card-text" id="price">Rs.2690.00</p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-24">
                            <form >
                                <div class="form-group d-flex justify-content-between" >
                                    <div class="form-check" >
                                        <input class="form-check-input" type="radio" name="options" id="small" value="option1">
                                        <label class="form-check-label" for="option1">S</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="options" id="medium" value="option2">
                                        <label class="form-check-label" for="option2">M</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="options" id="large" value="option3">
                                        <label class="form-check-label" for="option3">L</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="options" id="xl" value="option4">
                                        <label class="form-check-label" for="option4">XL</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="options" id="xxl" value="option5">
                                        <label class="form-check-label" for="option5">XXL</label>
                                    </div>
